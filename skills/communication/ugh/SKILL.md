---
name: ugh
description: One breath, the tldr. Say the last message in a single sentence, plus a You line only when something actually needs me. The shortest summary, for when I am tired.
disable-model-invocation: true
metadata:
  summary: "One breath. Restates the last message as a single sentence, plus a You line only when something actually needs you"
---
