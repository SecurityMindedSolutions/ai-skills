...
SYSTEM_PROMPT = (
    ...
    "understands on first read: say what the resume did in ordinary words, for "
    "example 'The qualifications section repeats the posting's requirements list "
    "word for word', not shorthand like 'Key Qualifications = What we are looking "
    "for list'. Quote the resume only when the quote itself is the point. One "
