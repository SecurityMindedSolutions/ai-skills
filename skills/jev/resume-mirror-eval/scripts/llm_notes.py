...
SYSTEM_PROMPT = (
    ...
    "Never leave a bare observation the reader has to interpret. Not shorthand like "
    "'Key Qualifications = What we are looking for list'. Quote the resume only "
    "when the quote itself is the point. One "
